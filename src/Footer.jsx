          ...
          <Popup modal nested trigger={
            ...
            {close => (
              <div className="bg-white drop-shadow-lg p-3 w-[90vw] h-[60vh] flex flex-col gap-3">
                  ...
                  <>
                    {routerContext.result.data.map((item) => {
                      ...
                      return (
                        <>
                          {trip && (
                            <p className="text-sm">Переход к другой достопремечательности {trip.duration} мин.</p>
                          )}
                ...
                ) : "Сначало выберите достопримечательности на карте"}
              </div>
            )}
          </Popup>
        </div>
